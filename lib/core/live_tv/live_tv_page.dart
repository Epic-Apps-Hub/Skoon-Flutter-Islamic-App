...
class _LiveTvPageState extends State<LiveTvPage> {
  ...
  @override
  void dispose() {videoPlayerController.dispose();
    ...
    return Scaffold(
      ...
      body: Center(
       ...
       Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
        children: [
               EasyContainer(color: darkPrimaryColor,borderRadius: 8.r,
                onTap: () {
                  ...
                  chewieController = ChewieController(
                      videoPlayerController: videoPlayerController,
                      aspectRatio: 3 / 2,
                      autoPlay: true,placeholder: const CircularProgressIndicator(
                ...
                child: Text(
                  links[0]["name"],
                  style: TextStyle(color: Colors.white, fontSize: 14.sp,fontFamily: 'roboto'),
                )),
            EasyContainer(color: darkPrimaryColor,borderRadius: 8.r,
                onTap: () {
                  videoPlayerController =
