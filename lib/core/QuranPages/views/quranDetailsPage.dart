...
// final ScrollOffsetListener scrollOffsetListener = ScrollOffsetListener.create()
  ...
  Widget buildTextPreview(String fontFamily) {
    return Container(
  ...
  List<Widget> generateTextPreviews(List<String> fontFamilies) {
    List<Widget> textPreviews = [];

    for (String fontFamily in fontFamilies) {
      textPreviews.add(buildTextPreview(fontFamily));
    }
                                                ...
                                                if (checkIfPageIncludesQuarterAndQuarterIndex(
                                                  ...
                                                  if (checkIfPageIncludesQuarterAndQuarterIndex(
                                                    ...
                                                    EasyContainer(
                                                      ...
                                                      margin: 0,
                                                      child: Text(
                                                        "${convertToArabicNumber(index.toString())} | ${(checkIfPageIncludesQuarterAndQuarterIndex(widget.quarterJsonData, quran.getPageData(index), indexes).quarterIndex + 1) == 1 ? "" : "${convertToArabicNumber((checkIfPageIncludesQuarterAndQuarterIndex(widget.quarterJsonData, quran.getPageData(index), indexes).quarterIndex).toString())}/${convertToArabicNumber(4.toString())}"} الحزب ${convertToArabicNumber((checkIfPageIncludesQuarterAndQuarterIndex(widget.quarterJsonData, quran.getPageData(index), indexes).hizbIndex + 1).toString())} ",
                                                        style: TextStyle(
                                                          fontFamily:
                                                              'aldahabi',
                                                          fontSize: 12.sp,
                                                              ...
                                                              child: Container(height: 10.h,)));
                                                                    ...
                                                                    spans.add(
                                                                      ...
                                                                      style:
                                                                        ...
                                                                        backgroundColor: bookmarks.contains("${e["surah"]}-$i")
                                                                            ? colorsOfBookmarks[bookmarks.indexOf("${e["surah"]}-$i")]
                                                                      ...
                                                                      children: [
                                                                        TextSpan(
                                                                            ...
                                                                            ,
                                                                            style:
                                                                                TextStyle(color: isVerseStarred(e["surah"], i) ? Colors.amber : Colors.blueAccent, fontFamily: "KFGQPC Uthmanic Script HAFS Regular")),
                                                                      ...
                                                                      spans.add(
                                                                        ...
                                                                        children: [
                                                                          TextSpan(
                                                                              ...
                                                                              ,
                                                                              style: TextStyle(color: isVerseStarred(e["surah"], i) ? Colors.amber : Colors.blueAccent, fontFamily: "KFGQPC Uthmanic Script HAFS Regular")),
                                                                        ],
                                                                      ));
                                                                    }
                                                                    return spans;
                                                                ...
                                                                spans.add(
                                                                  ...
                                                                  style:
                                                                    ...
                                                                    fontFamily:
                                                                        getValue(
                                                                            "selectedFontFamily"),
                                                                    backgroundColor: bookmarks.contains(
                                                                            "${e["surah"]}-$i")
                                                                        ? colorsOfBookmarks[bookmarks.indexOf(
                                                                            "${e["surah"]}-$i")]
                                                                  ...
                                                                  spans.add(
                                                                      WidgetSpan(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            Icons.bookmark,
                                                                            color:
                                                                                colorsOfBookmarks2[bookmarks.indexOf("${e["surah"]}-$i")],
                                                                          )));
                                                                }
                                                              }
                                                              return spans;
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      child: CircleAvatar(
                        backgroundColor:
                            index == 1 ? Colors.blueAccent : Colors.grey,
                        child: const Icon(
                          Icons.font_download,
                          color: Colors.white,
                        ),
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      child: CircleAvatar(
                        backgroundColor:
                            index == 2 ? Colors.blueAccent : Colors.grey,
                        child: const Icon(
                      ...
                      children: [
                        ...
                        EasyContainer(
                          color: primaryColors[getValue("quranPageolorsIndex")]
                              .withOpacity(.05),
                          onTap: () {
                            updateValue("greenBookmark",
                                "${surahNumber.toString()}-${verseNumber.toString()}");
                            // printYellow(bookmarks);
                            reloadBookmarks();
                            setstatee(() {});
                            setState(() {});
                            richTextKeys[index - 1]
                                ...
                                if (getValue("greenBookmark") != null)
                                  Expanded(
                                    child: Align(
                                      ...
                                      child: Text(
                                          getVerse(
                                            int.parse(getValue("greenBookmark")
                                                .toString()
                                                .split('-')[0]),
                                            int.parse(getValue("greenBookmark")
                                                .toString()
                        ...
                        EasyContainer(
                          ...
                          onTap: () {
                            updateValue(
                                "redBookmark", "$surahNumber-$verseNumber");
                            reloadBookmarks();
                            setstatee(() {});
                            setState(() {});
                            richTextKeys[index - 1]
                        ...
                        EasyContainer(
                          ...
                          onTap: () {
                            updateValue(
                                "blueBookmark", "$surahNumber-$verseNumber");
                            reloadBookmarks();
                            setstatee(() {});
                            setState(() {});
                            richTextKeys[index - 1]
